...
<div class="card mb-4 border-0 shadow-sm" style="border-radius: 20px;">
    <div class="card-body p-4">
        {{-- Container Flex untuk memisahkan Judul (Kiri) dan Tombol (Kanan) --}}
        <div class="d-flex align-items-center justify-content-between">
            
            {{-- Sisi Kiri: Icon dan Teks --}}
            ...
            <div class="text-end">
                <a href="{{ route('pimpinan.export.peminjaman', $lab->id_lab) }}"
        ...
        {{-- Garis Dekorasi Bawah (Warna Kuning/Orange) --}}
        <div class="mt-3"
    ...
    <table class="table table-hover align-middle">
        <thead>
            <tr>
                ...
                <th class="text-start-custom">BARANG & PEMINJAM</th> {{-- Tetap kiri agar mudah dibaca --}}
                <th>JUMLAH</th>
                <th>WAKTU PINJAM</th>
                <th>WAKTU KEMBALI</th>
                <th>STATUS</th>
                <th width="8%">DETAIL</th> {{-- Ganti aksi jadi kolom detail kecil saja --}}
            </tr>
        </thead>
        <tbody>
            @forelse ($peminjaman as $index => $item)
                ...
                @endphp
                <tr>
                    <td class="ps-3 text-center text-muted small">{{ $peminjaman->firstItem() + $index }}</td>
                    ...
                    <td class="text-center">
                        {{-- Tombol Detail Saja (Tanpa Hapus) --}}
                        <button type="button" class="btn btn-sm btn-light-primary p-2 btn-detail"
                            ...
                            {{-- ... data attributes lainnya tetap sama ... --}}
        ...
        <div class="card border border-secondary-subtle bg-light-subtle mb-3" style="border-radius: 15px;">
            <div class="card-body p-3">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <span class="badge {{ $item->status == 'dikembalikan' ? 'bg-info-subtle text-info' : 'bg-warning-subtle text-warning' }}"
                        style="font-size: 8px;">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <button type="button" class="btn btn-sm btn-link text-decoration-none p-0 fw-bold btn-detail"
                        style="font-size: 11px;" data-bs-toggle="modal" data-bs-target="#modalDetail"
                        {{-- ... data attributes sama ... --}}>
                        Detail >
                    </button>
                </div>
            </div>
