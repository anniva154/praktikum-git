...
<div class="welcome-card mb-4 d-flex justify-content-between align-items-center">
    <div>
        ...
        <p class="welcome-subtitle mb-0">
            Pantau seluruh aktivitas dan aset SIMLAB secara real-time.
        </p>
        <div class="welcome-line"></div>
    </div>

    {{-- TOMBOL UNDUH DISEBELAH KANAN --}}
    <div class="dropdown">
        <button class="btn btn-primary dropdown-toggle shadow-sm" type="button" data-bs-toggle="dropdown" style="border-radius: 10px; font-weight: 600;">
            <i class="bi bi-download me-2"></i>Unduh Laporan
        </button>
        <ul class="dropdown-menu dropdown-menu-end shadow border-0">
            <li><a class="dropdown-item" href="#"><i class="bi bi-file-earmark-pdf text-danger me-2"></i>Laporan Bulanan (PDF)</a></li>
            <li><a class="dropdown-item" href="#"><i class="bi bi-file-earmark-excel text-success me-2"></i>Data Aset (Excel)</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="#"><i class="bi bi-printer me-2"></i>Cetak Ringkasan</a></li>
        </ul>
    </div>
</div>
    ...
    <div class="row g-4 mt-2">
        <div class="col-lg-4 col-md-6">
            <div class="chart-card">
                <h6 class="chart-title">Analisis Kerusakan Mingguan</h6>
        ...
        <div class="col-lg-4 col-md-6">
            <div class="chart-card">
                <h6 class="chart-title">Persentase Kondisi Barang</h6>
                <div class="chart-wrapper">
        ...
        <div class="col-lg-4 col-md-12">
            <div class="chart-card">
                <h6 class="chart-title">Tren Aktivitas Peminjaman</h6>
                <div class="chart-wrapper">
