  ...
  <div class="row g-2">
      ...
      <div class="card dashboard-card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-1">
            <h1 class="fw-bold text-primary mb-0">{{ $barang }}</h1>
            <i class="bi bi-box-seam dashboard-icon text-primary"></i>
          </div>
          <p class="dashboard-label text-secondary">Data Barang</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card dashboard-card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-1">
            <h1 class="fw-bold text-success mb-0">{{ $barang }}</h1>
            <i class="bi bi-clipboard-data dashboard-icon text-success"></i>
          </div>
    ...
    <div class="col">
      <div class="card dashboard-card">
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between mb-1">
            <h1 class="fw-bold text-info mb-0">2</h1>
            <i class="bi bi-arrow-left-right dashboard-icon text-info"></i>
          </div>
          <p class="dashboard-label text-secondary">Riwayat Peminjaman</p>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card dashboard-card">
        <div class="card-body">
          ...
          <div class="d-flex align-items-center justify-content-between mb-1">
            <h1 class="fw-bold text-danger mb-0">3</h1>
