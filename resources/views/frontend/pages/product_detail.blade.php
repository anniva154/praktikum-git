                                                                    ...
                                                                    <div class="row">
																		...
																		<div class="col-lg-12 col-12">
																			<div class="form-group button5">	
																				<button type="submit" class="btn_su">Submit</button>
																			</div>
																		</div>
																	</div>
																</form>
...
<style>
		...
		.quantity {
			display: flex;
			align-items: center;
			gap: 5px; /* Jarak antar tombol plus/minus dan input */
		}
		...
		/* Hover effect untuk tombol cart */
		.btn-cart:hover {
		...
		/* Tombol Wishlist */
		.btn-wishlist {
			background-color: #f3c331; /* Warna kuning */
		...
		.btn-wishlist i {
			font-size: 18px;
			color: white; /* Pastikan ikon tetap putih */
		}

		/* Hover effect untuk tombol wishlist */
		.btn-wishlist:hover {
			background-color: #e2b824; /* Warna hover untuk tombol wishlist */
			transform: scale(1.1); /* Sedikit pembesaran saat hover */
			box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2); /* Efek bayangan */
		}
